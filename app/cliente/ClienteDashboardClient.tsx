    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <main style={{ paddingBottom: 90 }} className="cliente-main">
        <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          {/* Banner liquidar */}
          {data.deudaTotal > 0 && (
            <section style={{ background: 'var(--bg-2)', border: '1.5px dashed var(--border)', borderRadius: 'var(--radius)', padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
              <div style={{ width: 44, height: 44, borderRadius: 12, background: '#fff', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <svg width="22" height="22" fill="none" stroke="var(--accent)" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              </div>
              <div>
                <h4 style={{ fontSize: 14, fontWeight: 700, color: 'var(--text)', marginBottom: 3 }}>¿Querés liquidar tu deuda?</h4>
                <p style={{ fontSize: 12, color: 'var(--text-2)', lineHeight: 1.5 }}>Contactanos para obtener un descuento al cancelar hoy.</p>
              </div>
            </section>
          )}
